...
const ATTRACTIONS = {
  TDL: [
    ...
    { id: "tdl-buzz",     name: "バズ・ライトイヤーのアストロブラスター", area: "トゥモローランド", type: "ライド",       popularity: 0.70, capacity: 0.78, infoId: "134" },
    ...
    { id: "tdl-jungle",   name: "ジャングルクルーズ",                   area: "アドベンチャーランド", type: "ライド",     popularity: 0.60, capacity: 0.70, infoId: "366" },
  ...
  TDS: [
    ...
    { id: "tds-turtle",   name: "タートル・トーク",                     area: "アメリカンウォーターフロント", type: "シアター", popularity: 0.50, capacity: 0.85, infoId: "164" },
  ],
};
