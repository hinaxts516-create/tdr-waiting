...
const ATTRACTIONS = {
  TDL: [
    ...
    { id: "tdl-bigthunder", name: "ビッグサンダー・マウンテン", area: "ウエスタンランド", type: "絶叫", popularity: 0.82, capacity: 0.75, infoId: "110", closed: true },
    { id: "tdl-space", name: "スペース・マウンテン", area: "トゥモローランド", type: "絶叫", popularity: 0.8, capacity: 0.72, infoId: "133", closed: true },
    ...
    { id: "tdl-pirates", name: "カリブの海賊", area: "アドベンチャーランド", type: "ライド", popularity: 0.55, capacity: 0.92, infoId: "102", closed: true },
    ...
    { id: "tdl-auto-3", name: "チップとデールのツリーハウス", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "127", closed: true },
    { id: "tdl-auto-4", name: "ドナルドのボート", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "129", closed: true },
    ...
    { id: "tdl-auto-14", name: "スイスファミリー・ツリーハウス", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "105", closed: true },
    ...
    { id: "tdl-auto-20", name: "ピノキオの冒険旅行", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "117", closed: true },
    { id: "tdl-auto-21", name: "ガジェットのゴーコースター", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "128", closed: true },
    ...
    { id: "tdl-auto-24", name: "空飛ぶダンボ", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "118", closed: true },
  ...
  TDS: [
    ...
    { id: "tds-indy", name: "インディ・ジョーンズ“・アドベンチャー”", area: "ロストリバーデルタ", type: "ライド", popularity: 0.84, capacity: 0.72, infoId: "150", closed: true },
