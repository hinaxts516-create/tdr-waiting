...
const ATTRACTIONS = {
  TDL: [
    ...
    { id: "tdl-pirates", name: "カリブの海賊", nameEn: "Pirates of the Caribbean", area: "アドベンチャーランド", type: "ライド", popularity: 0.55, capacity: 0.92, infoId: "102" },
    ...
    { id: "tdl-auto-10", name: "カントリーベア・シアター", nameEn: "The Country Bear Theater", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "108" },
    ...
    { id: "tdl-auto-14", name: "スイスファミリー・ツリーハウス", nameEn: "Swiss Family Treehouse", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "105", closed: true },
    ...
    { id: "tdl-auto-20", name: "ピノキオの冒険旅行", nameEn: "Pinocchio's Daring Journey", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "117" },
    { id: "tdl-auto-21", name: "ガジェットのゴーコースター", nameEn: "Gadget's Go Coaster", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "128" },
  ...
  TDS: [
    ...
    { id: "tds-auto-40", name: "ディズニーシー・エレクトリックレールウェイ", nameEn: "DisneySea Electric Railway", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "142" },
    { id: "tds-auto-41", name: "ビッグシティ・ヴィークル", nameEn: "Big City Vehicles", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "141" },
    { id: "tds-auto-42", name: "海底2万マイル", nameEn: "20,000 Leagues Under the Sea", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "146" },
    { id: "tds-auto-43", name: "スカットルのスクーター", nameEn: "Scuttle's Scooters", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "154" },
    { id: "tds-auto-44", name: "フェアリー・ティンカーベルのビジーバギー", nameEn: "Fairy Tinker Bell's Busy Buggies", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "463" },
    { id: "tds-auto-45", name: "ジャスミンのフライングカーペット", nameEn: "Jasmine's Flying Carpets", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "172" },
    { id: "tds-auto-46", name: "ブローフィッシュ・バルーンレース", nameEn: "Blowfish Balloon Race", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "157" },
    { id: "tds-auto-47", name: "ジャンピン・ジェリーフィッシュ", nameEn: "Jumpin' Jellyfish", area: "—", type: "アトラクション", popularity: 0.6, capacity: 0.7, infoId: "156" },
  ],
};
